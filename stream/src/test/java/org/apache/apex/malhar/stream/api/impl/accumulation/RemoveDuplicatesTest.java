...
public class RemoveDuplicatesTest
{
  ...
  @Test
  public void RemoveDuplicatesTestStream()
  {
    ...
    stream.window(new WindowOption.GlobalWindow(), new TriggerOption().accumulatingFiredPanes().withEarlyFiringsAtEvery(1))
        .accumulate(new RemoveDuplicates<String>())
        .addOperator(collector, collector.input, null)
    ...
    Assert.assertEquals(9, collector.getResult().getValue().size());
