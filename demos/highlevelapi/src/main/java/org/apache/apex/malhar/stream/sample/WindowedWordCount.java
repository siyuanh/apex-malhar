...
public class WindowedWordCount implements StreamingApplication
{
  ...
  public void populateDAG(DAG dag, Configuration conf)
  {
    ...
    ApexStream<Tuple.TimestampedTuple<String>> stream = StreamFactory.fromInput("input", input, input.output)
    ...
    WindowedStream<PojoEvent> wordCounts =
        windowedWords.countByKey(new Function.MapFunction<Tuple.TimestampedTuple<String>, Tuple<KeyValPair<String, Long>>>()
        {
          @Override
        ...
        }).map(new FormatAsTableRowFn()).print();
